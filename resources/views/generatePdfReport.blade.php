...
<html>
   ...
   <style>
      ...
      @page { margin: 490px 50px 100px 50px; }
      header { position: fixed; left: 0px; top: -490px; right: 0px; height: 150px; text-align: center; }
      footer{  position: absolute; height: 20px;bottom:100px;line-height: 1.3;font-family: 'Open Sans', sans-serif; font-size:16px;}
   </style>
   <header>
            ...
            <td>
               <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                  <tr>
                     ...
                     <td style="width:40%; text-align:left"><img style="width:450px" src="images/safe_drugs.png" class="logo-image"></td>
               ...
               <td style="width:40%; padding:0px 10px;vertical-align:middle;">
                  <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                     <tr>
                        ...
                        @else
                        <td style="width:100%; border-bottom:2px solid #dedede;font-family: 'Open Sans', sans-serif;font-size:22px;padding:5px 0px; font-weight:bold" class="print-fs-14"></td>
                        @endif 
                     </tr>
                  </table>
               </td>
                                 ...
                                 @if(!empty($notPrescribedDetected))
                                    ...
                                    @foreach($notPrescribedDetected as $key => $testType)
                                       <tr class="table-6-row">
                                          ...
                                          @foreach($tests as $resultValue)
                                             @if($key == $resultValue->dendi_test_name)
                                                @if($testType['result_value'] > $resultValue->ULOQ)
                                                   <p style="font-family: 'Open Sans';text-align: right;font-size:21px;margin: 0px !important;">{{  " > ". $resultValue->ULOQ  }}</p>
                                                @else
                                                   <p style="font-family: 'Open Sans';text-align: right;font-size:21px;margin: 0px !important;">{{  number_format((float)$testType['result_value'], 2, '.', '') }}</p>
                                                @endif 
                                             @endif 
                                          @endforeach
                                          </td>
                                       ...
                                       <tr>
                                          ...
                                          @foreach($tests as $resultValue)
                                             @if(ucwords($key) == ucwords($resultValue->dendi_test_name)|| $key == $resultValue->dendi_test_name)
                                               @if($resultValue->class == 'NSAID' && strpos($icdCode, 'Chronic kidney disease') !== false)                                                <p style="color:red;font-family: 'Open Sans';margin: 0px !important;font-size:21px">[CI] NSAID medications reduce blood flow to the kidneys and should be avoided for patients with Chronic Kidney Disease</p>
                                               @endif
                                             @endif
                                          @endforeach
                                          @foreach($contraindicationComments as $keys => $description)
                                             ...
                                             @endif 
                                          @endforeach
                                          @foreach($sections as $keyIndex => $value)
                                             @foreach($generalComments as $generalComment)
                                                @if($value->section_id == 2 && $value->comment_id == $generalComment->id)
                                          
                                                   @isset($testType['id'])
                                                      @if (!empty($testType['id']))
                                                         @if($testType['id'] == $generalComment->test_id)
                                                         <p style="color:#111;font-family: 'Open Sans';margin: 0px !important;font-size:21px">{{ $generalComment->comment}}</p>
                                                         @endif
                                                      @endif
                                                   @endisset
                                          ...
                                          @foreach($arrayResult as $name => $value)
                                             @if(ucwords($name) == ucwords($key))
                                                @if(str_contains($value, '[CI]') && ucfirst($name) == "Metformin" && str_contains($icdToMeshCodes, 'D007674'))
                                                ...
                                                @elseif(str_contains($value, '[CI]'))
                                                   @foreach($tests as $resultValue)
                                                      @if($key == ucwords($resultValue->dendi_test_name) || $key == $resultValue->dendi_test_name)
                                                         @if($resultValue->class == "Diuretic" && str_contains($icdToMeshCodes, 'D007674'))
                                                            <p style="color:red;font-family: 'Open Sans';margin: 0px !important;font-size:21px;display:none !important;">{{  $value }}</p>
                                                         @else
                                       ...
                                       @if($key == 'Methamphetamine')
                                          @foreach($methData as $methKey => $methValue)
                                             <tr class="table-6-row">
                                                ...
                                                <td>
                                                <p style="font-family: 'Open Sans';text-align: right;font-size:21px">{{  floor($methValue['result_value'])." % "  }}</p>
                                                </td>
                                             </tr>
                                             @if($methKey == 'D-Methamphetamine %')   
                                                @if($methValue['result_value'] != '0')
                                                   <tr class="table-6-row">
                                                      <td>
                                                      &nbsp;
                                                      </td>
                           ...
                           <td colspan="2">
                              <table cellpadding="0" cellspacing="0" border="0" style="width:100%;padding:0px 20px;" class="print-height">
                                 ...
                                 <tr>
                                    ...
                                    @foreach($sections as $keyIndex => $value)
                                       @foreach($generalComments as $generalComment)
                                          @if($value->section_id == 3 && $value->comment_id == $generalComment->id)
                                 ...
                                 <tr class="table-6-row">
                                    ...
                                    <td>
                                       @if($result['result_flag'] == 'Detected')
                                          @foreach($tests as $resultValue)
                                             @if($medicineName == ucwords($resultValue->dendi_test_name)|| $medicineName == $resultValue->dendi_test_name)
                                                @if($result['result_value'] > $resultValue->ULOQ)
                                                   <p style="font-family: 'Open Sans';text-align: right;font-size:21px;margin: 0px !important;">{{  " > ". $resultValue->ULOQ  }}</p>
                                                @else
                                                   <p style="font-family: 'Open Sans';text-align: right;font-size:21px;margin: 0px !important;">{{  number_format((float)$result['result_value'], 2, '.', '') }}</p>
                                                @endif 
                                             @endif 
                                          @endforeach
                                       @else
                                       <p style="font-family: 'Open Sans';text-align: right;font-size:21px;margin: 0px !important;">{{  $result['result_flag'] }}</p>
                                       @endif 
                                 ...
                                 <tr>
                                    ...
                                    @foreach($arrayResult as $name => $value)
                                       @if(ucwords($name) == ucwords($medicineName))
                                          @if(ucfirst($name) == "Metformin" && str_contains($icdToMeshCodes, 'D007674') && str_contains($icdToMeshCodes, 'D003920'))
                                          <p style="color:red;font-family: 'Open Sans';margin: 0px !important;font-size:21px">"[CI] Type 2 diabetes mellitus without complications with Chronic kidney disease, Stage 3a". ( {{ $metforminText }} ) </p>
                                          @elseif(str_contains($value, '[CI]') && ucfirst($name) == "Metformin" && str_contains($icdToMeshCodes, 'D007674'))
                                             <p style="color:red;font-family: 'Open Sans';margin: 0px !important;font-size:21px">{{  $value }} ( {{ $metforminText }} ) </p>
                                          @elseif(str_contains($value, '[CI]'))
                                             @foreach($tests as $resultValue)
                                                @if(ucwords($medicineName) == ucwords($resultValue->dendi_test_name) || $medicineName == $resultValue->dendi_test_name)
                                    ...
                                    @foreach($sections as $key => $value)
                                       @foreach($generalComments as $generalComment)
                                          @if($value->section_id == 1 && $value->comment_id == $generalComment->id)
                                             @if($result['id'] == $generalComment->test_id)
                                             <p style="color:#111;font-family: 'Open Sans';margin: 0px !important;font-size:21px">{{ $generalComment->comment}}</p>
                                             @endif
                                          @endif
                                       @endforeach
                           ...
                           <tr>
                              <td colspan="2">
                                 <table cellpadding="0" cellspacing="0" border="0" style="width:100%; height:100px; border-collapse:collapse" class="print-height">
                                    <tr>
                                       {{-- <td>{{  $notDetectednotPrescribed }}</td>  --}}
