...
<html>
         ...
         <tr>
            <td>
               <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                  <tr>
                     <td style="width:25%"><img style="width:163px;margin-top: 10px;" src="images/qr.png" class="qr-image"></td>
                     <td style="width:40%; text-align:center">
                        @foreach($labLocations as $labLocation)
                           @if($labLocation->location == $in_house_lab_location)
                              <img style="height:150px; width: 250px;" src="images/logo_image/{{ $labLocation->logo_image }}" class="new-star-print-logo">
                           @endif
                        @endforeach
                     </td>
                     <td style="width:35%; text-align:right">
                        @foreach($labLocations as $labLocation)
                           @if($labLocation->location == $in_house_lab_location)
                              <p style="margin:0; color:#084ba0; margin-top:5px;font-family: 'Open Sans', sans-serif;text-align:right; font-size:16px" class="print-fs-14">{{ $labLocation->printable_location }}</p>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                           ...
                           <tr>
                              @if(!empty($patientPhone))
                                 <td style="width:100%; border-bottom:2px solid #dedede;font-family: 'Open Sans', sans-serif;font-size:22px;padding:5px 0px; font-weight:bold" class="print-fs-14">Patient Phone Number: {{ $patientPhone }}</td>
                              @else
                                 ...
                                 @if(!empty($notPrescribedDetected))
                                    ...
                                    @foreach($notPrescribedDetected as $key => $testType)
                                       <tr class="table-6-row">
                                          <td>
                                             <p style="font-family: 'Open Sans';text-transform:uppercase;font-size:21px;margin: 0px !important;">{{ $testType['class'] }}</p>
                                          </td>
                                          <td>
                                             @if(empty($testType['description']))
                                                <p style="font-weight:600;font-family: 'Open Sans';font-size:21px;margin: 0px !important;">{{  $key }}</p> 
                                             @else
                                                <p style="font-weight:600;font-family: 'Open Sans';font-size:21px;margin: 0px !important;">{{  $key }} ({{ $testType['description'] }})</p> 
                                             @endif
                                          </td>
                                          <td>
                                             <p style="font-family: 'Open Sans';text-align: right;font-size:21px;margin: 0px !important;">{{ $testType['LLOQ'] }}</p>
                                          </td> 
                                          <td>
                                             @if($testType['result_quantitative'] > $testType['ULOQ'])
                                                <p style="font-family: 'Open Sans';text-align: right;font-size:21px;margin: 0px !important;">{{ " > ". $testType['ULOQ'] }}</p>
                                             @else
                                       ...
                                       <tr>
                                          <td colspan="4">
                                             @if($testType['class'] == 'NSAID' && strpos($icdCode, 'Chronic kidney disease') !== false)
                                             ...
                                             @foreach($arrayResult as $name => $value)
                                                @if(ucwords($name) == ucwords($key))
                                                   ...
                                                   @elseif(str_contains($value, '[CI]'))
                                                      @if(ucwords($testType['class']) != "Diuretic")
                                                         @if(ucwords($testType['class']) == "Antidiabetic")
                                                            @foreach($icdCodeArr as $icdCodeArr => $icdCodeArr_val)
                                                               @if(strpos($icdCodeArr_val, "diabetes") !== false && strpos($icdCodeArr_val, " with ") !== false) 
                                                ...
                                                @endif 
                                             @endforeach
                                             @if(!array_key_exists($key,$ddiComments))
                                                ...
                                                @endif
                                             @endif 
                                             @foreach($ddiComments as $keys => $description)
                                                @if(ucwords($keys) == ucwords($key))
                                                   @if(strtoupper($testType['class']) == 'NSAID' || strtoupper($testType['class']) == 'ANTICOAGULANT')
                                                      @if(strtoupper($testType['class']) == 'NSAID' && !empty($anticoagulantClassTestArray))
                                       ...
                                       @if($key == 'Methamphetamine')
                                          @foreach($methData as $methKey => $methValue)
                                             <tr class="table-6-row">
                                                ...
                                                <td>
                                                <p style="font-family: 'Open Sans';text-align: right;font-size:21px">{{  floor($methValue)." % "  }}</p>
                                                </td>
                                             </tr>
                           ...
                           <td colspan="2">
                              <table cellpadding="0" cellspacing="0" border="0" style="width:100%;padding:0px 20px;" class="print-height">
                                 ...
                                 <tr>
                                    ...
                                    <tr class="table-6-row">
                                       <td>
                                          <p style="font-family: 'Open Sans';text-transform:uppercase;font-size:21px;margin: 0px !important;">{{ $value['class'] }}</p>
                                       </td>
                                       <td>
                                          @if(empty($value['description']))
                                             <p style="font-weight:600;font-family: 'Open Sans';font-size:21px;margin: 0px !important;">{{  $key }}</p> 
                                             @else
                                             <p style="font-weight:600;font-family: 'Open Sans';font-size:21px;margin: 0px !important;">{{  $key }} ({{ $value['description'] }})</p> 
                                          @endif
                                       </td>
                                       <td>
                                          <p style="font-family: 'Open Sans';text-align: right;font-size:21px;margin: 0px !important;">{{  $value['LLOQ'] }}</p>
                                       </td> 
                                    </tr>
                                    <tr>
                                       <td colspan="3">
                                          @if($value['class'] == 'NSAID' && strpos($icdCode, 'Chronic kidney disease') !== false)
                                             <p style="color:red;font-family: 'Open Sans';margin: 0px !important;font-size:21px">[CI] NSAID medications reduce blood flow to the kidneys and should be avoided for patients with Chronic Kidney Disease</p>
                                          @endif 
                                          @foreach($arrayResult as $name => $arrayResult_value)
                                             @if(ucwords($name) == ucwords($key))
                                                @if(str_contains($arrayResult_value, '[CI]') && ucfirst($name) == "Metformin" && str_contains($arrayResult_value, 'Chronic kidney disease'))
                                                   <p style="color:red;font-family: 'Open Sans';margin: 0px !important;font-size:21px">{{  $arrayResult_value }} ( {{ $metforminText }} ) </p>
                                                @elseif(str_contains($arrayResult_value, '[CI]'))
                                                   @if(ucwords($value['class']) != "Diuretic")
                                                      @if(ucwords($value['class']) == "Antidiabetic")
                                                         @foreach($icdCodeArr as $icdCodeArr => $icdCodeArr_val)
                                                            @if(strpos($icdCodeArr_val, "diabetes") !== false && strpos($icdCodeArr_val, " with ") !== false) 
                                                               <p style="color:red;font-family: 'Open Sans';margin: 0px !important;font-size:21px">{{ $arrayResult_value }}</p>
                                                               @break;
                                                            @endif
                                                         @endforeach
                                                      @else
                                                   ...
                                                   @endif  
                                                @else 
                                                   <p style="color:#FF4500;font-family: 'Open Sans';margin: 0px !important;font-size:21px">{{  $arrayResult_value }}</p>
                                                @endif
                                             @endif 
                                          @endforeach
                                          @if(!array_key_exists($key,$ddiComments))
                                          ...
                                          @foreach($ddiComments as $keys => $description)
                                             @if(ucwords($keys) == ucwords($key))
                                                @if(strtoupper($value['class']) == 'NSAID' || strtoupper($value['class']) == 'ANTICOAGULANT')
                                                   @if(strtoupper($value['class']) == 'NSAID' && !empty($anticoagulantClassTestArray))
                                                      <p style="color:#FF4500;font-family: 'Open Sans';margin: 0px !important;font-size:21px">{{ $description }},(Bleeding Risk) - {{ implode(",",$anticoagulantClassTestArray['ANTICOAGULANT']) }}</p>   
                                                   @endif
                        ...
                        <tr>
                           ...
                           <table cellpadding="0" cellspacing="0" border="0" style="width:100%; padding:20px;" class="print-height">
                              ...
                              <tr>
                                 ...
                                 <tr class="table-6-row">
                                    <td>
                                       <p style="font-family: 'Open Sans';text-transform:uppercase;font-size:21px;margin: 0px !important;">{{ $result['class'] }}</p>
                                    </td>
                                    <td style="width:40%;">
                                       @if(!empty($result['description']))
                                          <p style="font-weight:600;font-family: 'Open Sans';margin: 0px !important;font-size:21px;margin: 0px !important;">{{  $medicineName }} ({{ $result['description'] }})</p>
                                       @else
                                          <p style="font-weight:600;font-family: 'Open Sans';font-size:21px;margin: 0px !important;">{{  $medicineName }} </p>
                                       @endif   
                                    </td>
                                    <td>
                                       <p style="font-family: 'Open Sans';text-align: right;font-size:21px;margin: 0px !important;">{{  $result['LLOQ'] }}</p>   
                                    </td>
                                    <td>
                                       @if($result['result_qualitative'] == 'Detected')
                                          @if($result['result_quantitative'] > $result['ULOQ'])
                                             <p style="font-family: 'Open Sans';text-align: right;font-size:21px;margin: 0px !important;">{{ " > ". $result['ULOQ'] }}</p>
                                          @else
                                 ...
                                 <tr>
                                    <td colspan="4">
                                       @if($result['class'] == 'NSAID' && strpos($icdCode, 'Chronic kidney disease') !== false)
                                          <p style="color:red;font-family: 'Open Sans';margin: 0px !important;font-size:21px">[CI] NSAID medications reduce blood flow to the kidneys and should be avoided for patients with Chronic Kidney Disease</p>
                                       @endif 
                                       @foreach($arrayResult as $name => $value)
                                          @if(ucwords($name) == ucwords($medicineName))
                                                @if(str_contains($value, '[CI]') && ucfirst($name) == "Metformin" && str_contains($value, 'Chronic kidney disease'))
                                                   <p style="color:red;font-family: 'Open Sans';margin: 0px !important;font-size:21px">{{  $value }} ( {{ $metforminText }} ) </p>
                                                   @elseif(str_contains($value, '[CI]'))
                                                      @if(ucwords($result['class']) != "Diuretic")
                                                         @if(ucwords($result['class']) == "Antidiabetic")
                                                            @foreach($icdCodeArr as $icdCodeArr => $icdCodeArr_val)
                                                               @if(strpos($icdCodeArr_val, "diabetes") !== false && strpos($icdCodeArr_val, " with ") !== false) 
                                                                  <p style="color:red;font-family: 'Open Sans';margin: 0px !important;font-size:21px">{{  $value }}</p>
                                                                  @break;
                                          ...
                                          @endif 
                                       @endforeach
                                       @if(!array_key_exists($medicineName,$ddiComments))
                                       ...
                                       @foreach($ddiComments as $keys => $description)
                                          @if(ucwords($keys) == ucwords($medicineName))
                                             @if(strtoupper($result['class']) == 'NSAID' || strtoupper($result['class']) == 'ANTICOAGULANT')
                                                @if(strtoupper($result['class']) == 'NSAID' && !empty($anticoagulantClassTestArray))
                                                   <p style="color:#FF4500;font-family: 'Open Sans';margin: 0px !important;font-size:21px">{{ $description }},(Bleeding Risk) - {{ implode(",",$anticoagulantClassTestArray['ANTICOAGULANT']) }}</p>   
                                                @endif
   ...
   @if(!empty($urlForFda))
      <table>
            <tr>
               <td style="font-family: 'Open Sans', sans-serif;font-size: 20px;padding-left: 10px;">For More Information</td>             
            </tr>
            <tr>
               <td>
                  @foreach($urlForFda as $url)
                     <p style="font-family: 'Open Sans';padding-left: 10px;font-weight:500;font-size:18px;color:#007bff;">{{ $url }}</p>
                  @endforeach
               </td>
            </tr>
      </table>
