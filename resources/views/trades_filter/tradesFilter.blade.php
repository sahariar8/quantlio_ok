                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ 'Failed PDF Report' }}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="list-inline m-0">
                                                        ...
                                                        <li class="list-inline-item">
                                                        @can('delete.failed.orders')
                                                            <button class="btn btn-danger deletebtn btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" value="{{$trade->id}}" title="Delete"><i class="fa fa-trash"></i></button>
                                                        @endcan
                                                          </li>
                                                    </ul>
                                                </td>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('delete.failed.orders') }}" method="POST">
                        @csrf
                        @method('DELETE')
...
@section('load_external_js')
  <script src="{{'js/tradesFailed.js'}}"></script>
@endsection
